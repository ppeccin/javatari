...
public class Screen implements ClockDriven, VideoMonitor {
	...
	private void canvasUpdateSize() {
		...
		synchronized (refreshMonitor) {
			...
			canvas.canvasMinimumSize(new Dimension((int) (displayWidth * DEFAULT_SCALE_X / DEFAULT_SCALE_Y), displayHeight));
		}
	}
	...
	private void paintLogo() {
		synchronized (refreshMonitor) {
			...
			Dimension ces = canvas.canvasEffectiveSize();
			int w = ces.width;
			int h = ces.height;
	...
	private void refresh() {
		...
		synchronized (refreshMonitor) {
			...
			Dimension ces = canvas.canvasEffectiveSize();
			int canvasEffectiveWidth = ces.width;
			int canvasEffectiveHeight = ces.height;
